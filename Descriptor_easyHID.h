...
#DEFINE __USB_DESCRIPTORS__
   ...
   // Tamaño del paquete transmitido por el PIC
   #define USB_CONFIG_HID_TX_SIZE   20
#endif

#ifndef USB_CONFIG_HID_RX_SIZE
   // Tamaño del paquete recibido por el PIC
   #define USB_CONFIG_HID_RX_SIZE   2  // Configurado por el usuario según aplicación.  
#endif
...
//////////////////////////////////////////////////////////////////
   ...
   const char USB_DEVICE_DESC[USB_DESC_DEVICE_LEN] ={
      //starts of with device configuration. only one possible
         ...
         USB_CONFIG_VID & 0xd8, ((USB_CONFIG_VID >> 8) & 0x04), //vendor id       ==9, 10
         USB_CONFIG_PID & 0x00, ((USB_CONFIG_PID >> 8) & 0x0b), //product id, don't use 0xffff       ==11, 12
